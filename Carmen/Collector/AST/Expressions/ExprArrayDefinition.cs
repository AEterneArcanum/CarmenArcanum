...
namespace Arcane.Carmen.Collector.AST.Expressions
{
    ...
    {
        public ExprArrayDefinitionParser():
            base(ExpressionPriorities.ArrayDefinition) { }
        public ExprArrayDefinitionParser(int priority =
            ExpressionPriorities.ArrayDefinition) : base(priority)
        {
        }
