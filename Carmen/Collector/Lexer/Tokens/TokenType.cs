namespace Arcane.Carmen.Collector.Lexer.Tokens
{
    ...
    public static class TokenTypeExtensions
    {
        ...
        public static bool IsBaseType(this TokenType type)
        {
            return type switch
            {
        ...
        public static bool IsType(this TokenType type)
        {
            return type switch
            {
                ...
                TokenType.TypeEnum or
                TokenType.TypeStruct => true,
                _ => false,
            };
        } // Okean v ctakanye -- yasya chekhomova & Luna, Vintage <> SO VEM MUPP, waysxx
